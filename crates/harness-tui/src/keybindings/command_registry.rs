...
define_command_metadata! {
    ...
    ("revert_workspace", "Rewind", "Rewind the conversation to an earlier turn"),
    ("slash_rewind", "Rewind", "Rewind the conversation to an earlier turn"),
...
define_slash_commands! {
    ...
    ("rewind", "slash_rewind", &["undo"], false, false),
