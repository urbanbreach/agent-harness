...
impl SemanticThemeColors {
    pub const fn from_theme(theme: &Theme) -> Self {
        Self {
            ...
            diff: DiffColors {
                context_background: theme.terminal_colors.canvas,
                added_background: theme.terminal_colors.diff_added,
                removed_background: theme.terminal_colors.diff_removed,
                added_gutter: theme.terminal_colors.diff_added_gutter,
                removed_gutter: theme.terminal_colors.diff_removed_gutter,
                added_highlight: theme.terminal_colors.diff_added_highlight,
                removed_highlight: theme.terminal_colors.diff_removed_highlight,
                hunk_header: theme.terminal_colors.diff_hunk_header,
            },
            tool: ToolColors {
