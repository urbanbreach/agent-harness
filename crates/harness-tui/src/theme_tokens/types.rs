...
use crate::lifecycle_choreography::LifecycleState;
use crate::viewport::{ResponsiveBreakpoints, ViewportId};

#[rustfmt::skip]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum ColorRole {
    Canvas, Shell, Panel, PanelElevated, Overlay, Card, ModalHover, SelectedCard, PromptActiveSurface, BorderSubtle, BorderStrong, BorderFocus, TextPrimary, TextSecondary, TextTertiary, TextAccent, TextInverse, StatusSuccess, StatusWarning, StatusError, StatusInfo, StatusDisabled, QuestionSurface, QuestionSelected, QuestionPrimary, QuestionAccent, QuestionSecondary, AgentBuild, AgentPlan, AgentDocs, AgentAsk, MarkdownHeadingH1, MarkdownHeadingH3, MarkdownHeadingH4, MarkdownHeadingH6, MarkdownLinkText, MarkdownCode, ScrollbarTrack, TerminalPrimary, TerminalSecondary, TerminalMuted, TerminalError, TerminalPaletteSection, TerminalForkAccent, DiffAdded, DiffRemoved, DiffAddedGutter, DiffRemovedGutter, DiffAddedHighlight, DiffRemovedHighlight, DiffHunkHeader,
}

#[rustfmt::skip]
impl ColorRole {
    pub const ALL: [Self; 51] = [Self::Canvas, Self::Shell, Self::Panel, Self::PanelElevated, Self::Overlay, Self::Card, Self::ModalHover, Self::SelectedCard, Self::PromptActiveSurface, Self::BorderSubtle, Self::BorderStrong, Self::BorderFocus, Self::TextPrimary, Self::TextSecondary, Self::TextTertiary, Self::TextAccent, Self::TextInverse, Self::StatusSuccess, Self::StatusWarning, Self::StatusError, Self::StatusInfo, Self::StatusDisabled, Self::QuestionSurface, Self::QuestionSelected, Self::QuestionPrimary, Self::QuestionAccent, Self::QuestionSecondary, Self::AgentBuild, Self::AgentPlan, Self::AgentDocs, Self::AgentAsk, Self::MarkdownHeadingH1, Self::MarkdownHeadingH3, Self::MarkdownHeadingH4, Self::MarkdownHeadingH6, Self::MarkdownLinkText, Self::MarkdownCode, Self::ScrollbarTrack, Self::TerminalPrimary, Self::TerminalSecondary, Self::TerminalMuted, Self::TerminalError, Self::TerminalPaletteSection, Self::TerminalForkAccent, Self::DiffAdded, Self::DiffRemoved, Self::DiffAddedGutter, Self::DiffRemovedGutter, Self::DiffAddedHighlight, Self::DiffRemovedHighlight, Self::DiffHunkHeader];
}
