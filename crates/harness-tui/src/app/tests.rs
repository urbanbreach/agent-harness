...
delegate_test!(composer_metadata_deduplicates_provider_backend_source_label => model_context_tests::composer_metadata_deduplicates_provider_backend_source_label);
