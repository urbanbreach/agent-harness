---
name: ask-gemini
description: Deprecated compatibility shim for provider-specific advisor requests; use ask.
---

# Ask Gemini compatibility shim

This skill is deprecated as an independent workflow. Route the request through `ask` with any provider preference treated as an optional advisor hint. Verify all advice against repository evidence before acting.
