---
name: swarm
description: Deprecated compatibility shim for coordinated execution; use team.
---

# Swarm deprecated

Do not start a separate swarm workflow. Route coordinated multi-agent execution to `team`, using Harness coordinator-native team tasks, mailbox messages, and workflow evidence.
