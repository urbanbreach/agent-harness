...
delegate_test!(permission_modal_allow_always_requests_coordinator_mode_change => permission_modal_tests::permission_modal_allow_always_requests_coordinator_mode_change);
delegate_test!(always_approve_mode_does_not_late_resolve_projected_permissions => permission_modal_tests::always_approve_mode_does_not_late_resolve_projected_permissions);
delegate_test!(pending_always_approve_enable_suppresses_only_ordinary_permission_ui => permission_modal_tests::pending_always_approve_enable_suppresses_only_ordinary_permission_ui);
delegate_test!(failed_always_approve_enable_restores_suppressed_permission_ui => permission_modal_tests::failed_always_approve_enable_restores_suppressed_permission_ui);
