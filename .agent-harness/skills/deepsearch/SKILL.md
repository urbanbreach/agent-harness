---
name: deepsearch
description: Deprecated compatibility shim for deep research/search; use analyze or autoresearch-goal.
---

# Deepsearch deprecated

Do not start a separate deepsearch workflow. Use `analyze` for repository-grounded read-only investigation, or `autoresearch-goal` for durable external research with validator evidence.
