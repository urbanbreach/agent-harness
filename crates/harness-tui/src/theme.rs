...
impl Theme {
    ...
    pub fn harness_dark() -> Self {
        Self {
            ...
            markdown: MarkdownColors {
                ...
                task_unchecked: rgb(108, 108, 108),
    ...
    pub fn harness_light() -> Self {
        Self {
            surface: SurfaceColors {
                canvas: rgb(238, 238, 238),
                shell: rgb(238, 238, 238),
                panel: rgb(238, 238, 238),
                panel_elevated: rgb(228, 228, 228),
                overlay: rgb(238, 238, 238),
                card: rgb(222, 222, 222),
                hover: rgb(0xD0, 0xD0, 0xD0),
                selected_card: rgb(222, 222, 222),
            },
            border: BorderColors {
                subtle: rgb(200, 200, 205),
                strong: rgb(165, 165, 165),
                focus: rgb(98, 98, 98),
            },
            text: TextColors {
                primary: rgb(38, 38, 38),
                secondary: rgb(118, 118, 118),
                tertiary: rgb(98, 98, 98),
                accent: rgb(125, 75, 198),
                inverse: rgb(238, 238, 238),
            },
            question_prompt: QuestionPromptColors {
                surface: rgb(228, 228, 228),
                selected: rgb(222, 222, 222),
                primary: rgb(38, 38, 38),
                accent: rgb(125, 75, 198),
                secondary: rgb(47, 100, 210),
            },
            status: StatusColors {
                success: rgb(55, 142, 35),
            ...
            markdown: MarkdownColors {
                heading_h1: rgb(10, 142, 112),
                heading_h2: rgb(47, 100, 210),
                heading_h3: rgb(108, 62, 178),
                heading_h4: rgb(98, 98, 98),
                heading_h5: rgb(118, 118, 118),
                heading_h6: rgb(142, 142, 142),
                link: rgb(47, 100, 210),
                link_text: rgb(47, 100, 210),
                code: rgb(15, 135, 162),
                task_checked: rgb(55, 142, 35),
                task_unchecked: rgb(68, 68, 68),
                muted: rgb(118, 118, 118),
                code_background: rgb(228, 228, 228),
                text: rgb(68, 68, 68),
                emph: rgb(68, 68, 68),
                strong: rgb(68, 68, 68),
                block_quote: rgb(118, 118, 118),
                list_item: rgb(118, 118, 118),
                list_enum: rgb(118, 118, 118),
                rule: rgb(118, 118, 118),
            },
            agents: AgentColors {
                build: rgb(47, 100, 210),
                plan: rgb(125, 75, 198),
                docs: rgb(162, 118, 18),
                ask: rgb(47, 100, 210),
                palette: [
            ...
            scrollbar: ScrollbarColors {
                track: rgb(238, 238, 238),
                thumb: rgb(200, 200, 205),
                thumb_active: rgb(165, 165, 165),
            },
            terminal_colors: TerminalColors {
                ...
                welcome_border: rgb(185, 185, 190),
                prompt_border: rgb(200, 200, 205),
                prompt_border_active: rgb(165, 165, 175),
                prompt_accent: rgb(68, 68, 68),
                active_prompt_surface: rgb(222, 222, 222),
                error: rgb(205, 48, 72),
                palette_section: rgb(125, 75, 198),
                fork_accent: rgb(125, 75, 198),
                assistant_error: rgb(118, 118, 118),
                diff_added: rgb(218, 242, 220),
                diff_removed: rgb(245, 218, 222),
                diff_added_gutter: rgb(218, 242, 220),
                diff_removed_gutter: rgb(245, 218, 222),
                diff_added_highlight: rgb(55, 142, 35),
                diff_removed_highlight: rgb(205, 48, 72),
...
fn transcript_glyphs(preferred: bool) -> TranscriptGlyphs {
    ...
    TranscriptGlyphs {
        ...
        scrollbar_track: if preferred { "│" } else { "|" },
        scrollbar_thumb: if preferred { "█" } else { "#" },
        more_below: if preferred { "▼" } else { "v" },
