...
- Prefer `harness captured-shell-summary` for noisy test runs, bounded read-only inspection, and compact verification summaries when exact raw output is not required.
