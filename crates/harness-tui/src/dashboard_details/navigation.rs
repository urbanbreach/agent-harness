...
use crate::dashboard::{
    DashboardEligibilityRules, DashboardProjectionError, DashboardReadModel,
    DashboardReplayRegistry, DashboardRow, SelectionKey, build_dashboard_read_model,
};

use super::fields::{DetailsActions, DetailsPaneFields, SessionMetadata, metadata_map};
