...
const PUBLIC_RUNTIME_TOP_LEVEL_CONFIG_KEYS: &[PublicConfigTopLevelKey] = &[
    ...
    runtime_key!("layout", InertCompatibility, no_schema, no_docs),
    ...
    runtime_key!("snapshot", InertCompatibility, no_schema, no_docs),
    runtime_key!("tool_output", InertCompatibility, no_schema, no_docs),
    runtime_key!("tools", InertCompatibility, no_schema, no_docs),
    runtime_key!("username", InertCompatibility, no_schema, no_docs),
    runtime_key!("watcher", InertCompatibility, no_schema, no_docs),
    runtime_key!(
        "providers",
        Compatibility,
        no_schema,
