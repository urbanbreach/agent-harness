...
const MOTION: MotionTokens = MotionTokens {
    all: [MotionToken { kind: MotionKind::ActiveTick, interval_ms: 4, frames: 0 }, MotionToken { kind: MotionKind::StreamingSpinner, interval_ms: 133, frames: 8 }, MotionToken { kind: MotionKind::ToolPulse, interval_ms: 33, frames: 16 }, MotionToken { kind: MotionKind::ToolFinishFlash, interval_ms: 33, frames: 12 }, MotionToken { kind: MotionKind::StartupShimmer, interval_ms: 100, frames: 8 }, MotionToken { kind: MotionKind::ToastLifetime, interval_ms: 1000, frames: 1 }],
};
#[rustfmt::skip]
