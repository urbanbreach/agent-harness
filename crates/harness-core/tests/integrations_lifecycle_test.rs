...
use harness_core::integrations::{
    run_multi_descriptor_discover_product, run_multi_plugin_lifecycle_product, FailingPlugin,
    HelloWorldPlugin, PluginActivationPermission, PluginEnablement, PluginExecutionSurface,
    PluginLifecycleError, PluginLifecycleEvent, PluginLifecycleRegistry, PluginLifecycleSummary,
    PluginRuntimeContract, PluginRuntimeError, PLUGIN_ENTRY_FILE_NAME, PLUGIN_HOOKS_FILE_NAME,
