---
name: ralph-init
description: Deprecated compatibility shim; initialize work through ralph with planning artifacts and mandatory architect verification.
---

# Ralph init deprecated

Do not use a separate initialization workflow. Start or resume `ralph` with the approved plan/test-spec/evidence handoff. Ralph must include mandatory architect verification before completion.
