...
pub struct CoordinatorConfig {
    ...
    pub always_approve_on_start: bool,
    ...
    pub agent_prompt_templates: BTreeMap<String, crate::model_resolution::ModelPromptTemplate>,
...
impl CoordinatorConfig {
    pub fn new(session_dir: impl Into<PathBuf>) -> Self {
        Self {
            ...
            agent_prompt_templates: BTreeMap::new(),
